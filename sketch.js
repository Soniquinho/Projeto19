...
//definir collider (colisor) para mainCyclist (ciclistaPrincipal) trex.setCollider("rectangle",0,0,400,trex.height);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    text("Pressione a Seta Para Cima Para Reiniciar!", 600, 300);
